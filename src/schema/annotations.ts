...
export const SCHEMA_ANNOTATIONS: Record<string, TableAnnotations> = {
  ...
  requirements: {
    ...
    columns: {
      ...
      priority: `Business priority: High, Medium, Low, Critical.`,
...
audit_results: {
  ...
  version_history: {
    ...
    columns: {
      ...
      requirement_id: `Related requirement baseline.`,
      version_number: `Captured version number.`,
      changed_by_user_id: `Corporate stakeholder author.`,
      change_description: `Reason for requirement iteration.`,
      state_snapshot: `Full recursive state snapshot of requirements.`,
      created_at: `Date ledger transaction was posted.`,
      updated_at: `Last modification timestamp.`,
    },
  },
  prd_versions: {
    ...
    columns: {
      ...
      generated_diagram: `Generated architecture diagram at this version.`,
  ...
  conversation_messages: {
    ...
    columns: {
      ...
      conversation_id: `Groups messages into a single conversation thread.`,
