...
// Single source of truth for the displayed PostgreSQL DDL.
// Loaded at build time from backend/init.sql (via Vite `?raw`), so the
// Schema Explorer always reflects the exact schema the backend provisions,
// instead of a stale hardcoded copy.
...
export default function App() {
  ...
  // Full SQL text for the Schema Explorer DDL viewer.
  // Imported from backend/init.sql (single source of truth) at the top of this file.
                ...
                <div className="flex-1 flex flex-col bg-slate-950 rounded-2xl shadow-lg overflow-hidden border border-slate-800">
                  <div className="bg-slate-900 px-5 py-3 border-b border-slate-800 flex justify-between items-center shrink-0">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[10px] font-mono text-emerald-400 bg-emerald-950/50 border border-emerald-900 px-2 py-0.5 rounded uppercase">{fullSqlText.split('\n').length} Lines</span>
                    </div>
                  </div>
